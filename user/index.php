  ...
  <body>
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><img class="d-inline-block" src="public/assets/img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">foodwaGon</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0" method="get">
              ...
              ?>
              <a class="btn btn-white shadow-warning text-warning" href="cart.php">
                <i class="fas fa-shopping-cart me-2"></i>
              </a>
              <div class="dropdown">
                  <a class="btn btn-white shadow-warning text-warning dropdown-toggle" href="" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              ?>
              <a class="btn btn-white shadow-warning text-warning" href="login.php" type="submit"> <i class="fas fa-user me-2"></i>Login</a>
              <?php
              }
              ?>
            </form>
      ...
      <section class="py-5 overflow-hidden bg-primary" id="home">
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 col-lg-6 order-0 order-md-1 mt-8 mt-md-0"><a class="img-landing-banner" href="#!"><img class="img-fluid" src="../admin/uploads/kfc-spicy.jpg" alt="hero-header" /></a></div>
          ...
          <div class="row h-100 gx-2 mt-7">
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="public/assets/img/gallery/discount-item-1.png" alt="..." />
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="public/assets/img/gallery/discount-item-2.png" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="public/assets/img/gallery/discount-item-3.png" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="public/assets/img/gallery/discount-item-4.png" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gx-3 h-100 align-items-center">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3" src="../admin/uploads/<?php echo $item['image']; ?>" alt="..." style="height: 250px;"/>
                          <div class="card-body ps-0">
                            <h5 class="fw-bold text-1000 text-truncate mb-1"><?php echo $item['name']; ?></h5>
                            <div><span class="text-warning me-2"><i class="fas fa-map-marker-alt"></i></span><span class="text-primary"><?php echo $item['description']; ?></span></div><span class="text-1000 fw-bold"><?php echo $item['price']; ?> MMK</span>
                          </div>
                        </div>
                        <div class="d-grid gap-2"><a class="btn btn-lg btn-danger" href="item.php?id=<?php echo $item['id']; ?>" role="button">Order now</a></div>
                      </div>
                      <?php
                        }
                      ?>
        ...
        <div class="container">
          ...
          <div class="row gx-2">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 h-100 mb-5">
              <a href="menus.php?id=<?php echo $restaurant['id']; ?>">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100 align-items-center">
                        ...
                        ?>
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <a href="restaurants.php?id=<?php echo $menu['id']; ?>">
                          <div class="card card-span h-100 rounded-circle"><img class="img-fluid rounded-circle" src="../admin/uploads/<?php echo $menu['image']; ?>" alt="..." style="height: 200px;" />
                            <div class="card-body ps-0">
                                <h5 class="text-center fw-bold text-1000 text-truncate mb-2"><?php echo $menu['name']; ?></h5>
                            </div>
                          </div>
                        </a>
                      </div>
      ...
      <section>
        <div class="bg-holder" style="background-image:url(public/assets/img/gallery/cta-one-bg.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
